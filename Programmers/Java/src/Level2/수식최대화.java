...
class 수식최대화 {
    ...
    public long solution(String expression) {
        ...
        List<String> priorities = makeOperatorPriorities(operators.stream().toList());
    ...
    private long extractResult(String expression, List<String> priorities) {
        ...
        for (String priority : priorities) {
            long result = calForPriority(0, 2, priority, expression);
    ...
    private long calForPriority(long value, int cur, String priority, String expression) {
